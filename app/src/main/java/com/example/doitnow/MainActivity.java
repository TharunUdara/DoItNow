...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nav.setOnItemSelectedListener(item -> {
            ...
            if (id == R.id.nav_profile) startActivity(new Intent(this, AccountActivity.class));
            else if (id == R.id.nav_info) startActivity(new Intent(this, InfoActivity.class));
            return true;
        });
    }
    ...
    private void showAddTaskDialog() {
        ...
        v.findViewById(R.id.btnOk).setOnClickListener(view -> {
            ...
            if (!name.isEmpty()) {
                taskList.add(new Task(name, selectedHour, selectedMinute, spinner.getSelectedItem().toString(), rbFocus.isChecked()));
                refreshData();
                dialog.dismiss();
            }
        });
